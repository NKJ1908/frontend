  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center w-full text-md">
              <label htmlFor="2" className="flex items-center gap-2 text-gray-600 cursor-pointer">
                <input id="2" type="checkbox" className="w-4 h-4 rounded accent-blue-500/60"/>
                Se souvenir de moi
              </label>
              <a href="#" className="text-blue-500 hover:underline"> Mot de passe oublie</a>
      </div>
      <Form.Submit asChild>
        <button
          type="submit"
